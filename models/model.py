...
class basemodel(nn.Module):
    def __init__(self, logger, **params) -> None:
        ...
        if self.params.get("metrics_type", None) == 'SEVIRSkillScore':
        ...
        elif self.params.get("metrics_type", None) == 'None':
        ...
        #if (self.visualizer_type == 'sevir_visualizer') or (self.visualizer_type == 'hmdb_visualizer'):
        #    from utils.visualizer import get_visualizer
        #    self.visualizer = get_visualizer(self.run_dir, dataset_type=params.get("dataset_type", "hmdb"))
        #else:
        #    raise NotImplementedError
        from utils.visualizer import get_visualizer
        self.visualizer = get_visualizer(self.run_dir, dataset_type=params.get("dataset_type", "hmdb"))
        ...
        if self.checkpoint_path is None:
            ...
            self.load_checkpoint(self.checkpoint_path, load_model=True, load_optimizer=False, 
